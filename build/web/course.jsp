    ...
    <body>
        ...
        <section class="Course">
            ...
            <%
                ...
                for (courses elem : co) {
                     if (!Integer.valueOf(elem.getLevel()).equals((Integer.valueOf(u.getLevel()) + 1))) {
                        System.out.println("c leve : " + (Integer.valueOf(elem.getLevel()) + 1));
                        System.out.println("u leve  :" + (Integer.valueOf(u.getLevel()) + 1));
                        continue;
                    }
            %>
            <div class="e">
